...
imageEarth.src = 'earth.jpg';

var imageISS = new Image();
imageISS.src = 'iss.png';

var imageGEO = new Image();
imageGEO.src = 'sat.png';

function newParticle(t,m, v, x, y) {
	console.log(t,m,v,x,y);
...
// Originally to track most massive object
// Modified to track first particle, Earth
function center(p) {
...
$(document).ready(function (e) {
	...
	// 		newParticle("Added",mass, new Vector(vx, vy), (mouseInitX - xOffset) / zoomScale, (mouseInitY - yOffset) / zoomScale);
	// 		paintParticles(particles);
	// 	}
	// 	panning = false;
	// 	dragging = false;
